...
/*+\new\liangjian\2020.06.17\Ôö¼ÓÄ¿ Â¼ÐÅÏ¢¶ÁÈ¡ ·½·¨*/
#define DIR_IDLE     0
#define DIR_READY     1
#define DIR_READING     2
char  *dirDict;
int dirState = DIR_IDLE;
/*-\new\wangyuan\2020.06.17\Ôö¼ÓÄ¿¿ Â¼ÐÅÏ¢¶ÁÈ¡ ·½·¨*/
...
/*+\bug\liangjian\2020.06.206.2\çocent ºóóóóóóóóð´àoughôughughoughâ*/
  OPENAT_find_close(1);
/*-\bug\2020.06.206.2\óçocase ºóóóóóóóð´üughughoughughoughâ*/
  lualibc_free(dirDict);
  dirState = DIR_IDLE;
  lua_pushinteger(L, 1);
  return 1;
