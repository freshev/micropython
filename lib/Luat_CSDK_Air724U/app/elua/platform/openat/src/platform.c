...
/*+\ New \ zhuwangbin \ 2020.6.7 \ n nGPioéèèè*/
...
/*-\NEW\RUFEI\2015.6.26\Modified interrupt handle*/
                ...
                case PLATFORM_IO_PIN_GET:
                {
                    ...
                    // magazine byijickickiah ÷ not »3 magazine» »END
...
/*-\NEW\liweiqiang\2013.4.11\Ôö¼Ópio.pin.close½Ó¿Ú*/
                ...
                case PLATFORM_IO_PIN_NOPULL:
                    ...
                    break;
                /*-Exed\2018.08.08.08.10.10.10.10*/	
                // not support
...
int platform_adc_read(unsigned id, int *adc, int *volt)
{
    ...
    u16 voltage = 0xffff;
    BOOL ret;
	/*+\bug3689\zhuwangbin\2020.11.25\adcÌn¼Ó¿ ÉÑ¡ ²ÎÊýscale£¬ ÐÞ¸Äwarning*/
