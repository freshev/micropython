...
/*+\NEW\zhuwangbin\2020.07.16\ÖØÐÂÕûÀncamera¼Ä´æÆ÷ºÍÅäÖÃÂß¼*/
...
static void prvCmaCallback(T_AMOPENAT_CAMERA_MESSAGE *pMsg)
{
    ...
    switch(pMsg->evtId)
    {
        ...
        {
            // »ñè¡ameraµãµÃµäê'sirs, ïèÌeè¡ee £ ¬è» ºôuscan Worköðashöîö
            if (platCamCtx.exCamera.bZbarScan)
			{
...
static BOOL prvCamOpen(void)
{
	...
	T_AMOPENAT_CAMERA_PARAM initParam =
	{
		...
		TRUE,
		TRUE, 
		/*+\NEW\zhuwangbin\2020.07.16\Ìn¼ÓVGAÅÄÕÕ¹¦ÄÜ£¬²»Ö§³ÖVGAÉ¨Âë*/
...
BOOL platform_CameraWriteReg(int *pInitCmd, int nInitCmdSize)
{
	...
	int i;
	/*+\bug\rww\2020.11.18\ÐÞ¸ÄÒ»´¦ÄÚ´æÐ¹Â©*/
	BOOL retval;
	/*-\bug\rww\2020.11.18\ÐÞ¸ÄÒ»´¦ÄÚ´æÐ¹Â©*/
...
{
	/*+ \ New \ zhuwangbin în 2020.06.1 Ê ê¹óãcamera é¨âëdemo £ ¬ · £ £ ¬ æeä »¿¬Ôú''Ê§ ° Û¼ìð èéé¨ÃèðÊ§ ° û £ ¬Ôú'ðÊ§ ° Û¼ìð'''ðê§ Û*/
	...
	/*-\NEW\zhuwangbin\2020.06.1\Ê¹ÓÃcamera É¨Âëdemo £¬·ÅÖÃ´ó¸Å°ëÐ¡Ê±£¬ÆÁÄ»¿¨ÔÚÉ¨ÃèÊ§°Ü£¬²»»e¼ÌÐøÖ´ÐÐÁË*/
...
/*+\NEW\zhuwangbin\2020.05.19\Ìn¼ÓcameraÅÄÕÕ¹¦ÄÜ*/
