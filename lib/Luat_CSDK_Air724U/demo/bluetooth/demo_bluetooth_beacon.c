...
BOOL advertising(VOID)
{
    ...
    iot_ble_iotctl(0,BLE_SET_BEACON_DATA,param1);//ÉèÖÃbeaconÊý¾Ý
...
/*param2.advparam = iot_os_malloc(sizeof(T_OPENAT_BLE_ADV_PARAM));
    ...
    iot_ble_iotctl(0,BLE_SET_ADV_PARAM,param2);//ÉèÖÃ¹ã²¥²ÎÊý
    if(param2.advparam != NULL)
        iot_os_free(param2.advparam);
    param2.advparam = NULL;*/
    iot_os_sleep(1000);
    param3.advEnable = 1;
    iot_ble_iotctl(0,BLE_SET_ADV_ENABLE,param3);//Ò¿¹o¹¹¹a² ¥
    return TRUE;
}
