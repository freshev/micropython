/************************************************************************************.
                  ...
                  qualified altogether (C), 2001–2011
...
typedef enum {
  PIN_NULL,
/*+\zhuwangbin\2018.09.18\Ìn¼Ó¹Ü½Å33-36,67,69,70-78, 80-81*/
	PIN_B6_IO33,     //33 FUN0
	PIN_C5_IO34,     //34 FUN0
	PIN_F6_IO35,		 //35 FUN0
	PIN_B5_IO36,     //36 FUN0
...
/*-\zhuwangbin\2018.09.18\Ìn¼Ó¹Ü½Å33-36,67,69,70-78, 80-81*/
  ...
  /*+NEW\lijiaodi\2018.08.23\ Ìn¼ÓGPIO26,27,28,23*/  
  PIN_D6_IO26,
  PIN_C7_IO27,
  PIN_F7_IO28,
...
typedef enum {
  UART1_PIN_CFG,
  UART2_PIN_CFG,
 /*+: \ Newreq-wm-608 \ BREZEN \ 2013.3.1 \ ½ «HOST UART × ªªæõn¨'®¿ú¹¹¹¹*/ 
  UART_HOST_PIN_CFG,
 /*-: \ newreq-wm-608 \ BREZEN \ 2013.3.1 \ ½ «HOST UART × ªªæõÍ¨'®¿ú¹¹¹¹*/ 
  UART_MAX_NUM
}DRV_CFG_PIN_UART_E;
...
/*+\ New \ amopenat-108 \ brezen \ 2014.7.3 \ Án¼ói2C1½ó¿ú*/
typedef enum {
  I2C1_PIN_CFG,
  I2C2_PIN_CFG,
  I2C3_PIN_CFG,
...
/*-\ new \ amopenat-108 \ brezen \ 2014.7.3 \ Án¼ó2C1½O*/
typedef enum {
  KEY_CONFIG_INVALID,
