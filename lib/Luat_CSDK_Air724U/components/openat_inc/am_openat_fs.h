...
/*+\ Bug wM-719 \ Maliang \ 2013.3.21 \ îä¼þïµn³½ó¿úºn² ¥ · ÅÒÔÆµÎÄ¼Þ½Ó¿ÚµÄÎÄ¼þÃÛ¸ÄÎªunicode Little Endingààðn*/
    const WCHAR* pszMountPointUniLe; // T¿¨¹ÒÔØ½Úµã,·ÃÎÊÊ±T¿¨ÎÄ¼þ¾ùÔÚ´ËÄ¿Â¼ÏÂ UNICODE little endian
/*-\ BUG WM-719 \ Maliang \ 2013.3.21 \ ÎÄ¼þÏµn³½Ó¿úºn² ¥ · ÅÒÔÆµÎÄ¼Þ½Ó¿ÚµÄÎÄ¼þÃÛ¸ÄÎªunicode Little Endingààðn*/
...
{
    E_AMOPENAT_FLASH_INTERNAL, // mount ÄÚ²¿µÄflashÇøÓò
    E_AMOPENAT_FLASH_EXTERN_PINLCD, // mount Íâ²¿µÄflashÇøÓò£¬Ê¹ÓÃLCD pin½Å¸´ÓÃ  V_LCD¹©µç
    E_AMOPENAT_FLASH_EXTERN_PINGPIO,// mount Íâ²¿µÄflashÇøÓò£¬Ê¹ÓÃGPIO pin½Å¸´ÓÃ V_PAD_1V8¹©µç
...
/*+\ Bug \ amopenat-74 \ brezen \ 2013.9.24 \ ìn¼óflash nv½ó¿ú £ ¬óãàèèèèèèèèóOô úô úöæ*/
#define  NV_SUCCESS                (0)
...
/*-\ bug \ amopenat-74 \ brezen \ 2013.9.24 \ ìn¼óflash nv½ó¿ú £ ¬óãàèèèèèèèóó¦ úô úöæ*/
