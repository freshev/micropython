/*************************************************************
  ...
  Others:
  History:
    Version ï¼?Date: Author: Modification:
    V0.1 2012.12.14 lifei creates a file
*************************************************************/
...
/*+ \ Bug \ Wj \ 2020.2.20 \ SsLe¬½óÖðCIPrxgI · ¬μÃμ½ÍÊõÛÊÝ¾ ¬μÃμ½ÍÊõÊêÊ¾ ª¶eðòõ »£ óàÊÝ¾Ý'NÎó*/
#define OPEANT_SOCKET_FIONREAD_CMD  1074030207// FIONREAD
/*- \ bug \ Wj \ 2020.2.20 \ ssle¬½óöðciprxgetetî · ¨μÃμ½ÍÊõÊý¾ £ ¬¶eðòêÊ¾ £ óàÊÝ¾Ý'NIó*/
...
/*+\ bug_1768 \ rww \ 2020.5.7 \ cipping² »³é¹¦*/
typedef enum
{
	SOC_IPPROTO_IP = 0,
	SOC_IPPROTO_ICMP
...
/*-\NEW\zhuwangbin\2018.11.27\Add dns task using openat dns interface*/
typedef enum
{
    SOC_DNS_REQ
} openDnsEvent;
...
/*\+new\lijiaodi\2020.2.12\Ìn¼ÓÓòÃû½âÎö\*/
...
/*\-new\lijiaodi\2020.2.12\Ìn¼ÓÓòÃû½âÎö\*/
/*-\NEW\AMOPENAT-54\brizen\2013.7.18\Add AT filtering interface between CI and DTE*/
