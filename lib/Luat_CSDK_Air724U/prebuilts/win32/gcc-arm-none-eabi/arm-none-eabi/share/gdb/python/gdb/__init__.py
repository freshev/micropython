...
#pkgutil.iter_Moduless is not available prior to Python 2.6.  Instead,
#manually iterate the list, collating the Python files in each Modules
            ...
            for py_file in py_files:
                ...
                try:
                    if modname in sys.modules:
                        #reload Moduless with duplicate names
...
def GdbSetPythonDirectory(dir):
    ...
    #note that reload overwrites the gdb Modules without deleting existing
    # attributes
