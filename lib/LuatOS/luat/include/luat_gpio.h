...
// If bsp does not define the maximum PIN number, then give it a default of 128.
...
//Invalid GPIO, used when certain function pins are not specified
...
/**
 * @brief gpio mode drives yhm27xx, short mode operates 1 register to read and write
 * @param pin GPIO number
 * @param chip_id yhm27xx device address
 * @param reg yhm27xx register address
 * @param is_read 1 read 0 write
 * @param data Output data when reading, incoming data when writing
