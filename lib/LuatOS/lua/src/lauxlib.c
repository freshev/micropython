...
LUALIB_API void luaL_requiref (lua_State *L, const char *modname,
  ...
  // The statement luaL_getsubtable cannot be deleted directly
  // The reason is that in other codes, the _LOADED table corresponding to LUA_LOADED_TABLE will exist by default. This can be confirmed by searching for LUA_LOADED_TABLE
  // Other codes directly obtain this table or elements in the table. Only here luaL_getsubtable will be called, and luaL_getsubtable will be created when the table does not exist.
