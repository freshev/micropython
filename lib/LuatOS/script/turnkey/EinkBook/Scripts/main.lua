...
tag = "EINKBOOK"
--Whether to enable the network distribution function (used with esptouch)
USE_SMARTCONFIG = false
--This is the address of the existing e-book server. If you build it yourself or the service below fails, please modify it.
serverAdress = "http://47.96.229.157:2333/"
--Change to the WiFi name and password required to connect (using the 2.4Ghz band, ESP32C3 cannot use 5GHz WiFi)
