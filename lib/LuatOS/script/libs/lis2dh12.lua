...
sys.taskInit(function()
    ...
    lis2dh12.init(i2cid)--Initialization, pass in i2c_id
    while 1 do
...
local function chip_check()
    i2c.send(i2cid, LIS2DH12_ADDRESS_ADR_LOW, LIS2DH12_CHIP_ID_CHECK)--Read device address
    ...
    if revData:byte() ~= nil then
        ...
        i2c.send(i2cid, LIS2DH12_ADDRESS_ADR_HIGH, LIS2DH12_CHIP_ID_CHECK)--Read device address
        sys.wait(50)
    ...
    i2c.send(i2cid, LIS2DH12_ADDRESS_ADR, LIS2DH12_CHIP_ID_CHECK)--Read device address
    sys.wait(50)
