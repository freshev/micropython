...
sys.taskInit(function()
    ...
    qmc5883l.init(i2cid)--Initialization, pass in i2c_id
    while 1 do
...
local function chip_check()
    i2c.send(i2cid, QMC5883L_ADDRESS_ADR_HIGH, QMC5883L_CHIP_ID_CHECK)--Read device address
    ...
    if revData:byte() ~= nil then
        ...
        i2c.send(i2cid, QMC5883L_ADDRESS_ADR_LOW, QMC5883L_CHIP_ID_CHECK)--Read device address
        sys.wait(50)
    ...
    i2c.send(i2cid, QMC5883L_ADDRESS_ADR, QMC5883L_CHIP_ID_CHECK)--Read device address
