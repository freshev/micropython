...
sys.taskInit(function()
    ...
    l3g4200d.init(i2cid)--Initialization, pass in i2c_id
    while 1 do
...
local function chip_check()
    i2c.send(i2cid, L3G4200D_ADDRESS_ADR_HIGH, L3G4200D_CHIP_ID_CHECK)--Read device address
    ...
    if revData:byte() ~= nil then
        ...
        i2c.send(i2cid, L3G4200D_ADDRESS_ADR_LOW, L3G4200D_CHIP_ID_CHECK)--Read device address
        sys.wait(50)
    ...
    i2c.send(i2cid, L3G4200D_ADDRESS_ADR, L3G4200D_CHIP_ID_CHECK)--Read device address
