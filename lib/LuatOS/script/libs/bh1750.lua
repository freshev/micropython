...
sys.taskInit(function()
    ...
    bh1750.init(i2cid)--Initialization, pass in i2c_id
    while 1 do
...
function bh1750.read_light()
    ...
    --local _,light = pack.unpack(i2c_recv(2),">h") -- In extreme cases, the lighting caused by data overflow appears negative, such as string.toHex(i2c_recv(2)) == "FFFF"
