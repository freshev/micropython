...
@usage
--Note: Calibration and algorithm are adjusted according to your own design conditions
...
--register
local INA226_CONFIG_REG         =   0x00    --Configuration
local INA226_SHUNT_VOL_REG      =   0x01    --voltage divider
local INA226_BUS_VOL_REG        =   0x02    --bus voltage
local INA226_POWER_REG          =   0x03    --power
local INA226_CURRENT_REG        =   0x04    --current
local INA226_CALIBRA_REG        =   0x05    --calibration
local INA226_MASK_REG           =   0x06    --Block Enable
local INA226_ALERT_REG          =   0x07    --alarm
local INA226_MANUFACTURER_ID_REG=   0xFE    --Manufacturer ID
local INA226_DIE_ID_REG         =   0xFF    --Device ID
