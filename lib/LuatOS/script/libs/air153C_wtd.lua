...
--     air153C_wtd.init(28)
--air153C_wtd.feed_dog(28,10)--28 is the watchdog pin, 10 is the setting watchdog feeding time
----air153C_wtd.set_time(1)--turn on the timing mode and then turn on this code, otherwise it will be invalid
-- end)
]]
