...
sys.taskInit(function()
    ...
    ads1115.init(i2cid)--Initialization, pass in i2c_id
    while 1 do
...
local ADS1115_DATA_REG   	        =   0x00    --conversion register
local ADS1115_CONF_REG			    =   0x01    --configuration register
local ADS1115_LOTH_REG			    =   0x02    --Threshold Comparator High Byte Register
local ADS1115_HITH_REG	            =   0x03    --Threshold Comparator Low Byte Register
...
local ADS1115_CONF_HCMD	            =   0x42	--AIN0 single-ended input В±4.096 V continuous mode 0 100 001 0
local ADS1115_CONF_LCMD	            =   0x83  	--128sps Legacy comparator Output active low Non-latching comparator Disable comparator and set ALERT/RDY to high impedance 100 0 0 0 11
