...
--For the main configuration items, Lua needs to distinguish between two compilation environments:
--The size of lua_Integer, controlled by LUA_32BITS, is enabled by default
--size_t size, related to the platform, usually 32bit on MCU
--Although it can be composed of two, there are only two actual situations. Currently:
