...
--The following message is sent to a LuatOS test group. It can be turned off at any time and replaced with your own value.
...
sys.taskInit(function()
    ...
    while 1 do
        local timestamp = tostring(os.time()) .. "000" --The timestamp of LuatOS only reaches seconds, but DingTalk requires milliseconds, with 3 zeros added.
        ...
        --content is the text content to be sent. For other formats, just splice the table according to the requirements of DingTalk.
        ...
        --Normally it will return 200, {"errcode":0,"errmsg":"ok"}
