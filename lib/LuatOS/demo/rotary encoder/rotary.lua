--rotary encoder
--The forward and reverse directions are determined according to the actual situation.
...
us_tick = us_tick * 1000 --When clutter is removed below 1ms, it can be modified according to actual needs.
