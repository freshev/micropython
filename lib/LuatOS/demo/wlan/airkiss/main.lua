...
sys.taskInit(function()
    ...
    while 1 do
        --Start the distribution network. The default is esptouch mode. Change it to AIRKISS here.
        ...
        if ret == false then
            ...
            --After obtaining the IP successfully, the distribution network information is stored in fdb for persistent storage.
