...
sys.taskInit(function()
    ...
    if spi_id then
        ...
        --Wait a moment to avoid the ink screen not being initialized.
        sys.wait(100)
        log.info("e-paper 1.54", "Testing Go")
        eink.clear()
        --Draw a few lines and a circle
...
--It is recommended to use the following method for firmware compiled after 2022.12.02
