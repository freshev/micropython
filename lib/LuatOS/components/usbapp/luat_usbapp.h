...
//Open the luatos built-in usb device config to realize the composite device function of virtual MSC, HID and serial port. For serial port transceiver, see luat_uart
