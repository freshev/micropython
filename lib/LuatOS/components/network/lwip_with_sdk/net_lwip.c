...
//				prvlwip.socket_busy |= (1 << socket_id);
		...
		break;
// case EV_LWIP_NETIF_INPUT: //In most cases, lwip of the SDK needs to handle it by itself
...
//			}
	...
	case EV_LWIP_NETIF_SET_IP:	//Generally processed internally by SDK's LWIP
...
// if (prvlwip.netif_network_ready[event.Param3] != event.Param1) //link up and down are generally processed internally by the LWIP of the SDK
//		{
//			if (event.Param1)
//			{
...
//		}
		...
		break;
// case EV_LWIP_NETIF_IPV6_BY_MAC: //Generally handled internally by SDK's LWIP
