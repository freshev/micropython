...
void sm9_print_bn(const char *prefix, const sm9_bn_t a); //Standard printing format
...
int  sm9_fp12_from_hex(sm9_fp12_t r, const char hex[65 * 12]); // This is obviously wrong
