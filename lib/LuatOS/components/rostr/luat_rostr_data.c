...
// This file is used to store static strings

//First are a few special strings
...
const luat_rostr_short44_t rostr_shr_datas[] = {
    ...
    {.str={.tt = LUA_TSHRSTR, .marked = 4, .extra = 0, .shrlen = 6, .hash = 0xC206C1AA}, .data="Print"},
