...
#define ES8311_MCLK_SOURCE              0       //If the hardware is not connected to MCLK, SCLK needs to be used as MCLK. Generally, it is not used unless there are not enough pins to save pins.
#define ES8311_DMIC_SEL                 0       //DMIC selection: The default selection is 0 for off and 1 for open.
...
#define ES8311_ADC_PGA_GAIN		        8       //ADC analog gain: (selection range 0~10), please see the corresponding DS description for the specific correspondence.
#define ES8311_ADC2DAC_SEL              0	    //LOOP selection: the internal ADC data is given to the DAC self-loop output: the default selection is closed 0, open is 1
#define ES8311_DAC_HP_ON	            0	    //The output load turns on the HP driver: the default selection is 0 for off and 1 for open.
#define ES8311_VDDA_3V3			        0x00
#define ES8311_VDDA_1V8			        0x01
#define ES8311_VDDA_VOLTAGE		        ES8311_VDDA_3V3    //The analog voltage selection is 3V3 or 1V8, which needs to match the actual hardware. The default selection is 3V3
