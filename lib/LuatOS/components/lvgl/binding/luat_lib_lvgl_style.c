...
/*Create a style and initialize it
...
/*To delete a style, use it with caution. The deletion operation is usually not performed.
...
/*Delete style_list, use with caution, usually the deletion operation will not be performed
