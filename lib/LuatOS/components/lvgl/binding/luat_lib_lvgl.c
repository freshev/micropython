...
//---------------------------------
// Several shortcut methods
//---------------------------------

/*Get the currently active screen object
@api lvgl.scr_act()
@return pointer screen pointer
@usage
...
@string theme name, optional values   are default/mono/empty/material_light/material_dark/material_no_transition/material_no_focus
@return bool returns true if successful, otherwise returns nil
@usage
...
/*LVGL sleep control, pause/resume refresh timer, currently only available for 105 and EC618
@api lvgl.sleep(enable)
@boolean true pause false resume
@usage
lvgl.sleep(true) --pause refresh and the system can sleep
lvgl.sleep(false) --Resume refresh and the system will not sleep*/
...
//Add more than one hundred functions of STYLE_DEC
