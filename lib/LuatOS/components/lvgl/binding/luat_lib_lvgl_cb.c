...
@func lua function, there are 2 parameters (obj, event), where obj is the current object, event is the event type, which is an integer
...
/*Set the component's signal callback
@api lvgl.obj_set_signal_cb(obj, func)
@userdata lvgl component pointer
@func lua function, there are 2 parameters (obj, signal), where obj is the current object, signal is the signal type, which is an integer
@return nil no return value*/
...
@userdata animation pointer
@userdata lvgl component pointer
@func lua function, there are 2 parameters (obj, value), where obj is the current object, signal is the signal type, which is an integer
@return nil no return value*/
...
@userdata animation pointer
@userdata lvgl component pointer
@func lua function has 1 parameter (anim), where anim is the current object
@return nil no return value*/
...
@userdata animation pointer
@userdata lvgl component pointer
@func lua function has 1 parameter (path), where path is the current object
@return nil no return value*/
...
@return bool Returns true if successful, false or nil if the object has been deleted
@return int The underlying return value, if obj is nil, return nil*/
