...
#if LV_USE_ANIMATION
/*Create and initialize an anim
@api lvgl.anim_create()
@return userdata anim pointer
@usage
...
@return userdata lv_anim_path_t pointer
@usage
...
@string type, supports linear/ease_in/ease_out/ease_in_out/overshoot/bounce/step
