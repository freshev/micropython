/*@Modules lora2
@summary lora2 driver Modules (supports multiple hangs)
@version 1.0
@date 2022.06.24
@demo lora
@tag LUAT_USE_LORA2*/
...
@return userdata If successful, the lora object will be returned, otherwise nil will be returned.
@usage
