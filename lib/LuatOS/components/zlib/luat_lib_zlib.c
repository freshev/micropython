/*@Modules zlib
@summary zlib compression/decompression (deprecated)
@version 1.0
@date 2022.01.06
@tagLUAT_USE_ZLIB
@deprecated Please use miniz or fastlz library
@usage
-- This library has been deprecated, please use miniz or fastlz library*/
...
/*zlib compression (requires about 270k memory, most mcu does not support)
@api zlib.c(input_file,output_file)
@string input_file input file
@string output_file output file
@return bool Normally returns true, failure returns false
@usage
...
/*zlib decompression (requires about 18k memory, supported by most mcu)
