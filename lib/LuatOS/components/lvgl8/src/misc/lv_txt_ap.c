...
const ap_chars_map_t ap_chars_map[] = {
    ...
    {1, 0xFE84, -1, 0, -1,  {1, 0}},    // a
    {2, 0xFE86, -1, 0, -1,  {1, 0}},    // was
    {3, 0xFE88, -1, 0, -1,  {1, 0}},    // ﷺ
    {4, 0xFE8A, 1, 2, -1,  {1, 0}},    //
    {5, 0xFE8E, -1, 0, -1,  {1, 0}},    // Come on
    {6, 0xFE90, 1, 2, -1,  {1, 1}},    // b
    {92, 0xFB57, 1, 2, -1,  {1, 1}},   // p
    {8, 0xFE96, 1, 2, -1,  {1, 1}},    // t
    {9, 0xFE9A, 1, 2, -1,  {1, 1}},    //w
    {10, 0xFE9E, 1, 2, -1,  {1, 1}},   // c
    {100, 0xFB7B, 1, 2, -1,  {1, 1}},  // f
    {11, 0xFEA2, 1, 2, -1,  {1, 1}},   //h
    {12, 0xFEA6, 1, 2, -1,  {1, 1}},   //kh
    {13, 0xFEAA, -1, 0, -1,  {1, 0}},   // of the
    {14, 0xFEAC, -1, 0, -1,  {1, 0}},   // z
    {15, 0xFEAE, -1, 0, -1,  {1, 0}},   // r
    {16, 0xFEB0, -1, 0, -1,  {1, 0}},   // g
    {118, 0xFB8B, -1, 0, -1,  {1, 0}},  // No
    {17, 0xFEB2, 1, 2, -1,  {1, 1}},   // Q
    {18, 0xFEB6, 1, 2, -1,  {1, 1}},   // Sh
    {19, 0xFEBA, 1, 2, -1,  {1, 1}},   // p
    {20, 0xFEBE, 1, 2, -1,  {1, 1}},   //Z
    {21, 0xFEC2, 1, 2, -1,  {1, 1}},   // i
    {22, 0xFEC6, 1, 2, -1,  {1, 1}},   //
    {23, 0xFECA, 1, 2, -1,  {1, 1}},   // A
    {24, 0xFECE, 1, 2, -1,  {1, 1}},   // na
    {30, 0x0640, 0, 0, 0,  {1, 1}},   // - (mad, hyphen)
    {31, 0xFED2, 1, 2, -1,  {1, 1}},   // f
    {32, 0xFED6, 1, 2, -1,  {1, 1}},   // Q
    {135, 0xFB8F, 1, 2, -1,  {1, 1}},  // k
    {33, 0xFEDA, 1, 2, -1,  {1, 1}},  // k
    {141, 0xFB93, 1, 2, -1,  {1, 1}},  // g
    {34, 0xFEDE, 1, 2, -1,  {1, 1}},   // for
    {35, 0xFEE2, 1, 2, -1,  {1, 1}},   // M
    {36, 0xFEE6, 1, 2, -1,  {1, 1}},   // n
    {38, 0xFEEE, -1, 0, -1,  {1, 0}},   // and
    {37, 0xFEEA, 1, 2, -1,  {1, 1}},   // e
    {39, 0xFEF0, 0, 0, -1, {1, 0}},   // ى
    {40, 0xFEF2, 1, 2, -1,  {1, 1}},   // Y
    {170, 0xFBFD, 1, 2, -1,  {1, 1}},   // Y
    {7, 0xFE94, 1, 2, -1,  {1, 0}},   // E
