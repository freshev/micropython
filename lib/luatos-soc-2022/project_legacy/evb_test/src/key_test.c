...
void key_pad_init(void)
{
    ...
    //Currently, key1 on the cloud speaker development board uses gpio, so it is temporarily used as a gpio interrupt. The subsequent design will be changed to wakeup pad.
