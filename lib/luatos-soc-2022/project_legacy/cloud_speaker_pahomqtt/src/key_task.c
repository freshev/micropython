...
luat_pm_wakeup_pad_isr_callback_t down_key_callback(int num)
{
    ...
    // If the new development board is not connected to the battery and only plugged in USB, this interrupt will always be triggered.
