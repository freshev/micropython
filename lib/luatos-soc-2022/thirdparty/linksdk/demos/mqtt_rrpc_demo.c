 ...
 *
 * For example: [1577589489.033][LK-0317] {YourDeviceName}&{YourProductKey}
 *
...
void demo_mqtt_default_recv_handler(void *handle, const aiot_mqtt_recv_t *packet, void *userdata)
{
    switch (packet->type) {
        ...
        case AIOT_MQTTRECV_PUB: {
            ...
            /*TODO: Process the business messages sent by the server. If you receive the rrpc message here, you can use the same topic when responding.*/
            /*For more information, please refer to https://help.aliyun.com/document_detail/90570.html*/

            /*The following is an example of an rrpc response:*/
            /* {
                char *payload = "pong";
                char resp_topic[256];
