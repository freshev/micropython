...
/*The default maximum socket establishment time*/
...
//Set custom certificate verification. After actual testing, the aliyun certificate needs to ignore the Common Name (CN) option to pass the verification.
