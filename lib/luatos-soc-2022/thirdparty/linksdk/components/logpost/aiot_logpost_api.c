 ...
 * API interface implementation of @brief logpost Modules, providing the ability to upload device-side logs to the cloud
 *
...
int32_t _logpost_send_nwkstats_rtt(logpost_handle_t *handle)
{
    ...
    msg.loglevel = AIOT_LOGPOST_LEVEL_INFO;     /*Log level*/
    msg.module_name = NWKSTAT_NET_RT;           /*The Modules corresponding to the log*/
    msg.code = 200;                             /*status code*/
    msg.msg_id = 0;
    msg.content = content;                      /*Log content*/
...
int32_t _logpost_send_nwkstats_conn(logpost_handle_t *handle)
{
    ...
    msg.timestamp = 0;                          /*Timestamp in ms. If you fill in 0, the SDK will use the current timestamp.*/
    msg.loglevel = AIOT_LOGPOST_LEVEL_INFO;     /*Log level*/
    msg.module_name = NWKSTAT_NET_CONN;         /*The Modules corresponding to the log*/
    msg.code = 200;                             /*status code*/
    msg.msg_id = 0;
    msg.content = content;                      /*Log content*/
