/**
 * @file aiot_ntp_api.c
 * @brief ntp Modules API interface implementation, providing the ability to obtain UTC time
 *
 * @copyright Copyright (C) 2015-2020 Alibaba Group Holding Limited
 **/

/*TODO: For the header file of this Modules, you only need to include ntp_private.h, but do not need to include aiot_ntp_api.h.*/
#include "ntp_private.h"

/*TODO: List the header files that need to be included in the core Modules*/
