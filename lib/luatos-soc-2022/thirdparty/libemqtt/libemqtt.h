 ...
 * Copyright 2009 Caixa Megica Software. All rights reserved.
 *
 * Fork developed by Vicente Ruiz Rodrnguez
 * Copyright 2012 Vicente Ruiz Rodrnguez <vruiz2.0@gmail.com>. All rights reserved.
 **/
...
#define MQTT_MSG_DISCONNECT   14<<4 /**< mqtt closes disconnect messages (it will be reported as long as there is a disconnection, regardless of whether it is reconnected)*/
...
typedef struct {
	...
	char *will_data; // Contains topic and payload
	uint32_t will_len;
