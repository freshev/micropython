 ...
 *	FUNCTION ENTRIES
 */
 /*Return value: -1: Unknown exception within the service
             0: Authentication passed
1: The current application is not authorized
2: The total application authorization exceeds the limit
3: The number of times the current device has been flashed exceeds the limit.
4: The current device or application authorization has been prohibited from use
5: Equipment parameters are abnormal or missing
6: Data parsing failed, the secret key does not match
7: Service flow control limit, please back off and try again.*/
int ivTTS_Auth(void);
