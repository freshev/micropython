...
typedef struct
{
    ...
    uint32_t aesMode        : 2; // 0 ¨C ECB, 1 ¨C CBC, 2 ¨C CTR
    uint32_t paddingMode    : 3;
    uint32_t ckLen          : 2; // 0 ¨C 128, 1 ¨C 192, 2 ¨C 256
    uint32_t aesCkSel       : 1; // 0 ¨C from configured CK address, 1 ¨C from efuse
    uint32_t                : 2;
    uint32_t subType        : 2; // 0 ¨C AES descriptor; 1 ¨C SHA descriptor
