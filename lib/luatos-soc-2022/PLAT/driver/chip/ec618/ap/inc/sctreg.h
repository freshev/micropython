 ...
 *                  0 ¨C crcbyte from s[x] to s[x+7], s[x+7] is placed in LSB, (reset value: 0)
 *                  1 ¨C crcbyte from s[x+7] to s[x], s[x+7] is placed in MSB
 * 25       1       comm_crc_in_bit_swap_ch0
 *                  0 ¨C CRC start from bit[0] of input byte, (reset value: 0)
 *                  1 ¨C CRC start from bit[7] of input byte
 **/
typedef union
{
    struct {
