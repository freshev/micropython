//Global variables, provided to obtain base station positioning information
...
static void lbsloc_Init_Task(void *param)
{
    ...
    uint8_t longitude[20] = {0}; // latitude
    ...
    // ret = luat_mobile_get_cell_info(&cell_info);//Get cell_info synchronously
    if (ret != 0)
    {
