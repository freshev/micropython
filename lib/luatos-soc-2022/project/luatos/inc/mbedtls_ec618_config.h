...
// Disabling SHA512 can save 10k
#ifdef LUAT_CONF_TLS_SHA512_DISABLE
#undef MBEDTLS_SHA512_C
#endif

// Turn off the encrypted version of UDP, similar to TCP's TLS/SSL, rarely used
...
// Close a few rarely used things
