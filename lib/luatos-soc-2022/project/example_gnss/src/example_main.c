...
static void gnss_setup_task(void *param)
{
    ...
    // The gnss power supply actually controls the GPIO that will be automatically pulled high when it is powered on. If you do not need to turn it on immediately after powering on, please change cfg.output_level to 0
