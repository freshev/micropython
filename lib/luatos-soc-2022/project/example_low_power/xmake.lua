local TARGET_NAME = "example_low_power"
...
target(TARGET_NAME)
    ...
    -- add_files("./src/example_ipv6_wakeup.c",{public = true})
    -- add_files("./src/remote_net_wakeup.c",{public = true})
    -- add_files("./src/psm_plus.c",{public = true})
