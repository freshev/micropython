...
STATIC bool camera_init_helper(camera_obj_t *camera, size_t n_pos_args, const mp_obj_t *pos_args, mp_map_t *kw_args) {
      enum {
        ARG_format,        ARG_framesize,        ARG_quality,
        ARG_d0,        ARG_d1,        ARG_d2,        ARG_d3,
        ARG_d4,        ARG_d5,        ARG_d6,        ARG_d7,
        ARG_VSYNC,     ARG_HREF,      ARG_PCLK,      ARG_PWDN,
        ARG_RESET,     ARG_XCLK,      ARG_SIOD,      ARG_SIOC,
        ARG_FREQ,      ARG_FBSIZE,    ARG_FBLOC,
    };
    ...
    if ((size != FRAMESIZE_96X96) && (size != FRAMESIZE_QQVGA) && (size != FRAMESIZE_QCIF) && (size != FRAMESIZE_HQVGA) &&
        (size != FRAMESIZE_240X240) && (size != FRAMESIZE_QVGA) && (size != FRAMESIZE_CIF) && (size != FRAMESIZE_HVGA) &&
        (size != FRAMESIZE_VGA) && (size != FRAMESIZE_SVGA) && (size != FRAMESIZE_XGA) && (size != FRAMESIZE_HD) &&
        (size != FRAMESIZE_SXGA) && (size != FRAMESIZE_UXGA) && (size != FRAMESIZE_FHD) && (size != FRAMESIZE_P_HD) &&
        (size != FRAMESIZE_P_3MP) && (size != FRAMESIZE_QXGA) && (size != FRAMESIZE_QHD) && (size != FRAMESIZE_WQXGA) &&
        (size != FRAMESIZE_P_FHD) && (size != FRAMESIZE_QSXGA)) {
...
STATIC mp_obj_t camera_init(size_t n_pos_args, const mp_obj_t *pos_args, mp_map_t *kw_args) {
    ...
    if (camera) return mp_const_true;
