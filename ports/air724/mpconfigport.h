...
#define MICROPY_PY_SYS_PLATFORM "Air724"
...
#define MICROPY_BEGIN_ATOMIC_SECTION()      ((int)iot_os_enter_critical_section ())
#define MICROPY_END_ATOMIC_SECTION(state)   (iot_os_exit_critical_section((HANDLE)state))
...
//#define MICROPY_PY_BUILTINS_HELP_TEXT       air724_help_text
//#define MICROPY_PY_IO_BUFFEREDWRITER        (1)
//#define MICROPY_PY_TIME_GMTIME_LOCALTIME_MKTIME (1)
//#define MICROPY_PY_TIME_TIME_TIME_NS        (1)
//#define MICROPY_PY_TIME_INCLUDEFILE         "ports/air724/modtime.c"

#define MICROPY_PY_OS_INCLUDEFILE   "ports/air724/modos.c"
...
#define MICROPY_PY_MACHINE_INCLUDEFILE      "ports/air724/modmachine.c"
...
//#define MICROPY_PY_MACHINE_PWM_INCLUDEFILE  "ports/air724/machine_pwm.c"
...
//#define MICROPY_PY_MACHINE_ADC_INCLUDEFILE  "ports/air724/machine_adc.c"

//#define MICROPY_PY_MACHINE_SPI              (1)
//#define MICROPY_PY_MACHINE_SOFTSPI          (0)

#define MICROPY_PY_MACHINE_UART                         (1)
#define MICROPY_PY_MACHINE_UART_INCLUDEFILE             "ports/air724/machine_uart.c"
#define MICROPY_PY_MACHINE_UART_READCHAR_WRITECHAR      (1)
#define MICROPY_HW_ENABLE_UART_REPL                     (1)

//#define MICROPY_PY_MACHINE_WDT              (1)
//#define MICROPY_PY_MACHINE_WDT_INCLUDEFILE  "ports/air724/machine_wdt.c"
...
#if defined(HW_REPL_USB)
#define HW_UART_REPL OPENAT_UART_USB
#elif defined(HW_REPL_UART_1)
#define HW_UART_REPL OPENAT_UART_1
#elif defined(HW_REPL_UART_2)
#define HW_UART_REPL OPENAT_UART_2
#endif
